...
const {
  definePartsStyle: switchPart,
  defineMultiStyleConfig: switchMultiStyle,
} = createMultiStyleConfigHelpers(switchAnatomy.keys);
const {
  definePartsStyle: selectPart,
  defineMultiStyleConfig: selectMultiStyle,
} = createMultiStyleConfigHelpers(selectAnatomy.keys);
const {
  definePartsStyle: numInputPart,
  defineMultiStyleConfig: numInputMultiStyle,
...
export const theme = extendTheme({
  ...
  lgColor: {
    activeBlueGradient:
      "linear-gradient(to bottom right, #d6e8ff 0%, #f0f7ff 100%)",
